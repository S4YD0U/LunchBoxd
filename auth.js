...
const Auth = {
  ...
  BADGES: [
    { id: 'first_review',   emoji: '✍️',  label: 'Première critique',  desc: 'A écrit sa 1ère critique',    condition: function(u){ return (u.reviews||[]).length >= 1; } },
    { id: 'review_5',       emoji: '📝',  label: 'Critique x5',        desc: 'A écrit 5 critiques',          condition: function(u){ return (u.reviews||[]).length >= 5; } },
    { id: 'review_10',      emoji: '🗒️', label: 'Critique x10',       desc: 'A écrit 10 critiques',         condition: function(u){ return (u.reviews||[]).length >= 10; } },
    { id: 'review_25',      emoji: '📖',  label: 'Gourmet',            desc: 'A écrit 25 critiques',         condition: function(u){ return (u.reviews||[]).length >= 25; } },
    { id: 'likes_10',       emoji: '❤️',  label: 'Populaire',          desc: 'A reçu 10 likes au total',     condition: function(u){ return Auth._totalLikes(u) >= 10; } },
    { id: 'likes_50',       emoji: '🔥',  label: 'En feu',             desc: 'A reçu 50 likes au total',     condition: function(u){ return Auth._totalLikes(u) >= 50; } },
    { id: 'likes_100',      emoji: '⭐',  label: 'Star',               desc: 'A reçu 100 likes au total',    condition: function(u){ return Auth._totalLikes(u) >= 100; } },
    { id: 'first_follower', emoji: '👥',  label: 'Premier fan',        desc: 'A obtenu son 1er abonné',      condition: function(u){ return (u.followers||[]).length >= 1; } },
    { id: 'followers_10',   emoji: '🌟',  label: 'Influenceur',        desc: 'A obtenu 10 abonnés',          condition: function(u){ return (u.followers||[]).length >= 10; } },
    { id: 'followers_50',   emoji: '👑',  label: 'Star du campus',     desc: 'A obtenu 50 abonnés',          condition: function(u){ return (u.followers||[]).length >= 50; } },
    { id: 'member_1m',      emoji: '🌱',  label: 'Membre 1 mois',      desc: 'Inscrit depuis 1 mois',        condition: function(u){ return Auth._memberMonths(u) >= 1; } },
    { id: 'member_6m',      emoji: '🌿',  label: 'Membre 6 mois',      desc: 'Inscrit depuis 6 mois',        condition: function(u){ return Auth._memberMonths(u) >= 6; } },
    { id: 'member_1y',      emoji: '🏆',  label: 'Vétéran',            desc: 'Inscrit depuis 1 an',          condition: function(u){ return Auth._memberMonths(u) >= 12; } },
  ],
  ...
  renderBadges: function(userData, options) {
    options = options || {};
    var badges = this.getBadges(userData);
...
(function() {
  ...
  function showWantedPopup() {
    ...
    overlay.innerHTML = `
      <div style="background:#1a1c17;border:2px solid #c8f542;border-radius:16px;padding:0;max-width:380px;width:90%;overflow:hidden;box-shadow:0 0 60px rgba(200,245,66,0.15);animation:popIn 0.4s cubic-bezier(0.34,1.56,0.64,1);">
        <!-- Header -->
        ...
        <!-- Photo -->
        <div style="position:relative;overflow:hidden;max-height:320px;display:flex;align-items:center;justify-content:center;background:#0d0e0b;">
          <img src="wanted.jpg" alt="Suspect" style="width:100%;object-fit:cover;object-position:top;filter:sepia(30%) contrast(1.1);max-height:320px;">
  ...
  function showPommesSmilePopup() {
    ...
    overlay.innerHTML = `
      <div style="background:#1a1c17;border:2px solid #c8f542;border-radius:16px;padding:0;max-width:360px;width:90%;overflow:hidden;box-shadow:0 0 60px rgba(200,245,66,0.2);animation:popIn 0.4s cubic-bezier(0.34,1.56,0.64,1);text-align:center;">
        ...
        <div style="overflow:hidden;max-height:300px;display:flex;align-items:center;justify-content:center;background:#0d0e0b;">
          <img src="pommes-smile.png" alt="Pommes smile !" style="width:100%;object-fit:cover;object-position:top;max-height:300px;">
        </div>
